const EventCard = () => {
    return (
        <div
            id="event-card"
            class="bg-gray-800 bg-opacity-60 flex flex-col items-center justify-between border-4  border-blue-400   text-center mt-4 cursor-default lg:max-w-xs py-6 px-9  "
        >

    ...
    <div className="App">
      ...
      <div id="landing" className="flex flex-col py-7 bg-black text-white min-h-screen  justify-between">
        ...
        <div className="flex flex-col items-center justify-center text-center">
          <img src={require('./assets/BootUp_23Logo-White.png')} className="max-w-sm" alt="" />
          <p className="mt-2 mb-1 tracking-widest font-semibold text-lg">BROUGHT TO YOU BY</p>
          <p className="font-semibold text-lg tracking-widest">DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING</p>
        </div>
        <div className="flex flex-row justify-center">
